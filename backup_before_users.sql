...
CREATE TABLE `templates` (
  ...
  CONSTRAINT `templates_template_category_id_foreign` FOREIGN KEY (`template_category_id`) REFERENCES `templates_categories` (`id`) ON DELETE CASCADE
...
CREATE TABLE `templates_categories` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `templates_categories_slug_unique` (`slug`)
...
INSERT INTO `templates_categories` VALUES (1,'SaaS','saas','2026-06-17 11:53:02','2026-06-17 11:53:02'),(2,'Événement','evenement','2026-06-17 11:53:02','2026-06-17 11:53:02');
...
-- Dump completed on 2026-06-17 14:30:10

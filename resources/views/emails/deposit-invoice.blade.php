...
<head>
    <meta charset="UTF-8">
    <title>Votre facture d'acompte {{ $depositInvoice->number }} - NorthFrame</title>
</head>
                    ...
                    <tr>
                        <td style="padding:40px 32px;background:#111827;text-align:center;">
                            ...
                            <h1
                                ...
                                font-weight:700;
                            ">
                                Votre facture d'acompte est disponible
                            </h1>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 20px;color:#334155;line-height:1.7;">
                                ...
                                Bonjour
                                <strong>{{ $depositInvoice->quote->customer->contact_name }}</strong>,
                            ...
                            <p style="color:#334155;line-height:1.7;">
                                ...
                                Suite à l'acceptation de votre devis
                                <strong>{{ $depositInvoice->quote->number }}</strong>,
                                veuillez trouver ci-joint votre facture d'acompte
                                <strong>{{ $depositInvoice->number }}</strong>.
                            ...
                            <p style="color:#334155;line-height:1.7;">
                                ...
                                Cette facture correspond à l'acompte prévu lors de l'acceptation
                                du devis et permet le démarrage de votre projet.
                            ...
                            ">
                                ...
                                La facture d'acompte est disponible en pièce jointe au format PDF.
                            ...
                            ">
                                ...
                                disposition pour toute question concernant cette facture.

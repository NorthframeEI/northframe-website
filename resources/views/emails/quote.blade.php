...
<head>
    <meta charset="UTF-8">
    <title>Votre devis {{ $quote->number }} - NorthFrame</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 20px;color:#334155;line-height:1.7;">
                                Bonjour
                                <strong>{{ $quote->customer->contact_name }}</strong>,
                            </p>

                            <p style="color:#334155;line-height:1.7;">
                                Suite à nos échanges, veuillez trouver ci-joint votre devis
                            ...
                            line-height:1.7;
                        ">
                                Le devis est disponible en pièce jointe au format PDF.
                            </p>
